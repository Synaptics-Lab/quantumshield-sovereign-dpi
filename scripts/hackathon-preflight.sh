#!/usr/bin/env bash
# ==============================================================================
# hackathon-preflight.sh — 10-Second Health Checker
# ==============================================================================
set -e
...
echo ""
echo "[1/4] Probing SCBFT Consensus (${RPC_URL})..."
...
echo ""
echo "[2/4] Verifying GovPay Sovereign Smart Contracts..."
...
echo ""
echo "[4/4] Verifying Cryptographic SDK Tests..."
